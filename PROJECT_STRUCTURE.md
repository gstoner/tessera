...
| `cmake/TesseraToolchainPins.cmake` | new (G-6/H-6)                              | CMake helpers pinning CUDA 13.4 / ROCm 10.0 (HIP 7.15) toolchains (measured 2026-09-15) |
...
- `cmake/TesseraToolchainPins.cmake` pins NVIDIA → CUDA 13.4 (PTX ISA 9.4) and
  AMD → ROCm 10.0 / HIP 7.15; `scripts/validate_{nvcc,hipcc}_compile.py` and
