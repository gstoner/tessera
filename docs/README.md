...
| Clifford / geometric algebra surface | implemented / lit-testable / hardware-runtime for all 17 registered Apple GPU fused GA kernels | `docs/spec/CLIFFORD_SPEC.md`, `docs/spec/GA_EBM_EXECUTION_STATUS.md`, `python/tessera/ga/`, `python/tessera/autodiff/geometric/`, `src/solvers/clifford/` |
