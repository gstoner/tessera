# Apple Backend integration review (moved)

> **This review has been consolidated into the single Apple backend
> reference: [apple_backend.md](apple_backend.md)** — see the **Metal 4 lane —
> implementation state** section (what's optimal, the P1–P8 findings status,
