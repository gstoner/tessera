...
This is a deliberate architectural decision. The Python surface is a clean API, not a separate language. See `archive/docs/old_concepts/Rust_Frontend_Research/tessera_frontend_architecture.md` for the rejected alternative.
