...
| NVFP4 E2M1 + UE4M3 block-scale MMA | `tessera_nvidia.nvfp4_block_scale_mma`; PTX assembles | **fails**: 128/128 outputs on live unit-scale probe | no runtime ABI | none | shown here as blocked | **blocked at numerical gate** |
