...
| Exact MXFP4 W4A8 | On gfx1201, packed E2M1 + E8M0/K32 weights and E4M3 + per-token FP32 activations execute through both a scalar oracle and an exact two-FP8-WMMA-per-group package. The generic scaled-matmul route carries isolated scale-group partials through Schedule/Tile and a strict Target-IR materializer into that proved ABI. | Decode/prefill selector tuning, independent-library throughput comparison, and gfx1200 proof. | [`gfx1201_mxfp4_w4a8_20260921`](../../../../benchmarks/baselines/gfx1201_mxfp4_w4a8_20260921/README.md) |
