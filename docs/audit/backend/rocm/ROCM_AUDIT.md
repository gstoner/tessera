...
| Exact MXFP4 W4A8 | On gfx1201, packed E2M1 + E8M0/K32 weights and E4M3 + per-token FP32 activations execute through scalar and exact FP8-WMMA packages. Versioned checkpoint/fragment/shuffled identities make byte order explicit; production decode preconverts once and consumes contiguous lane words. Route receipts, boundary/ragged/poison tests, an independent sampled FP32 oracle, HIP graph capture, and matched Radiance/libr4d timing are recorded. | Padded multistage fragment prefill, backend-neutral K-step barriers, remaining tuning axes, and gfx1200 proof. | [`gfx1201_mxfp4_production_20260922`](../../../../benchmarks/baselines/gfx1201_mxfp4_production_20260922/README.md) |
