...
- Depends on: —
- Start: host-free
- Latest: [the K unroll follows the storage's load width, and three AMD sources confirm the contract](INTEGRATED_COMPILER_LOG.md#2026-09-19--the-k-unroll-follows-the-storages-load-width-and-three-amd-sources-confirm-the-contract)
