...
- Depends on: —
- Start: host-free
- Latest: [the typed route's real levers: an LDS body that loses, the K unroll that wins, general-shape NVFP4, and the RDNA4 ceilings](INTEGRATED_COMPILER_LOG.md#2026-09-18--the-typed-routes-real-levers-an-lds-body-that-loses-the-k-unroll-that-wins-general-shape-nvfp4-and-the-rdna4-ceilings)
