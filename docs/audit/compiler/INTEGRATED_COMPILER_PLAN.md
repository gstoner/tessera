...
- Depends on: —
- Start: host-free
- Latest: [the owed loops: gfx1201 at every family, integer and bf16 storage on the typed route, the measured typed-route gap, public 2:4 sparse admission, and the three sm_120 items](INTEGRATED_COMPILER_LOG.md#2026-09-18--the-owed-loops-gfx1201-at-every-family-integer-and-bf16-storage-on-the-typed-route-the-measured-typed-route-gap-public-24-sparse-admission-and-the-three-sm120-items)
