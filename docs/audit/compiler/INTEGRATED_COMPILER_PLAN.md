...
- Depends on: —
- Start: host-free
- Latest: [GFX1201-PARITY slice 1: the fused matmul epilogue on the typed Tile→ROCm route](INTEGRATED_COMPILER_LOG.md#2026-09-17--gfx1201-parity-slice-1-the-fused-matmul-epilogue-on-the-typed-tilerocm-route)
