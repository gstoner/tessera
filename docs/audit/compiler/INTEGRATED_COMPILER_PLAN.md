...
- Depends on: —
- Start: host-free
- Latest: [ROCM-GLOBAL-LOAD-TR-1: the strided B gather becomes one instruction](INTEGRATED_COMPILER_LOG.md#2026-09-19--rocm-global-load-tr-1-the-strided-b-gather-becomes-one-instruction)
