...
- Depends on: —
- Start: host-free
- Latest: [the gfx1201 tail: two boxes swept to their real defects, and the benchmark surface reviewed](INTEGRATED_COMPILER_LOG.md#2026-09-17--the-gfx1201-tail-two-boxes-swept-to-their-real-defects-and-the-benchmark-surface-reviewed)
