...
- Depends on: —
- Start: host-free
- Latest: [the ROCm host's red zone, and four causes that were not what the errors said](INTEGRATED_COMPILER_LOG.md#2026-09-17--the-rocm-hosts-red-zone-and-four-causes-that-were-not-what-the-errors-said)
