...
- Depends on: —
- Start: host-free
- Latest: [the low-precision panel, and a VGPR reading that is not yet evidence](INTEGRATED_COMPILER_LOG.md#2026-09-19--the-low-precision-panel-and-a-vgpr-reading-that-is-not-yet-evidence)
