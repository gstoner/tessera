...
- Depends on: —
- Start: host-free
- Latest: [GFX1201-PARITY slice 2: twenty-four scalar and row-program families promoted on measurement](INTEGRATED_COMPILER_LOG.md#2026-09-17--gfx1201-parity-slice-2-twenty-four-scalar-and-row-program-families-promoted-on-measurement)
