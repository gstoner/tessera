...
- Depends on: —
- Start: host-free
- Latest: [the engineering loops: every owed item from the gfx1201 tail worked to its disposition](INTEGRATED_COMPILER_LOG.md#2026-09-17--the-engineering-loops-every-owed-item-from-the-gfx1201-tail-worked-to-its-disposition)
