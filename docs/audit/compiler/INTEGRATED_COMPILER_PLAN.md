...
- Depends on: —
- Start: host-free
- Latest: [the engineering loops: gfx1201 to 62 of 63 families, the first RDNA4-only consumer, and the sm_120 dispatch that never read its own corpus](INTEGRATED_COMPILER_LOG.md#2026-09-17--the-engineering-loops-gfx1201-to-62-of-63-families-the-first-rdna4-only-consumer-and-the-sm120-dispatch-that-never-read-its-own-corpus)
