...
- Depends on: —
- Start: host-free
- Latest: [recorded increment](INTEGRATED_COMPILER_LOG.md#2026-09-13--gfx1201-scheduled-integration-and-fleet-validation)
...
- Start: host-free
- Latest: [recorded increment](INTEGRATED_COMPILER_LOG.md#2026-09-14--native-automatic-sparse-selection)
...
- Depends on: —
- Start: host-free
- AD gate: [native composed HVP execution](AUTODIFF_EXECUTION_PLAN.md#native-composed-hvp-execution-2026-09-14) adds static CPU saved-product tangents and bounded gfx1201 HVP execution; arbitrary CFG/effects, dynamic results, higher orders and general GPU binding remain open.
- Latest: [recorded increment](INTEGRATED_COMPILER_LOG.md#2026-09-14--hvp-product-identity-and-cuda-execution)
