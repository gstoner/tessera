...
| Conformance | Header and test command accuracy | Header should match current mixed Phase 1-8 status and validation commands | `docs/spec/CONFORMANCE.md`; `docs/spec/COMPILER_REFERENCE.md` | spec-stale | Remove old “Phases 1-3 complete; 4-6 planned” header and duplicate `tests/unit/` rows. |
