...
| `rocm_gfx1151` | `tessera-target-artifact` | `tessera-rocm-executable` | `declared_exact` | `native` | `partial` | `partial` | `rocm` |
| `rocm_gfx1200` | `tessera-target-artifact` | `tessera-lower-to-rocm` | `declared_shared_builder` | `absent` | `partial` | `absent` | `rocm` |
| `rocm_gfx1201` | `tessera-target-artifact` | `tessera-lower-to-rocm` | `declared_shared_builder` | `native` | `partial` | `absent` | `rocm` |
