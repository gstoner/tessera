...
| `Runtime execution matrix` | closed | 263 | 263 | 0 | apple_cpu=2, apple_gpu=24, cpu=6, nvidia_sm120=52, rocm=92, x86=87 | Add rows only when a launch path actually executes. |
