...
| `Direct test evidence` | mixed | 402 | 515 | 113 | covered_by_family=26, directly_tested=409, hardware_gated=4, structural_only=76 | Convert structural_only and needs_direct_test rows into direct compare fixtures; keep hardware_gated tied to backend proof. |
...
| `Runtime ABI symbols` | mixed | 558 | 873 | 315 | apple=692, nvidia=8, rocm=13, x86=160 | Reduce stub-only ABI rows where a backend claims native execution. |
...
| `Direct test evidence` | mixed | 113 | covered_by_family=26, directly_tested=409, hardware_gated=4, structural_only=76 | Convert structural_only and needs_direct_test rows into direct compare fixtures; keep hardware_gated tied to backend proof. | `docs/audit/generated/test_coverage.csv` |
