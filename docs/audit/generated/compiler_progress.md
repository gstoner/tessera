...
| Item | Status | Ready | Total | Open | Detail | Next |
|---|---|---:|---:|---:|---|---|
| `Verifier coverage` | closed | 207 | 207 | 0 | real=207 | Add real verifier implementations for no_verifier ops, prioritizing native codegen lanes. |
...
| `Verifier coverage` | closed | 0 | real=207 | Add real verifier implementations for no_verifier ops, prioritizing native codegen lanes. | `docs/audit/generated/verifier_coverage.csv` |
