...
| `Runtime execution matrix` | closed | 155 | 155 | 0 | apple_cpu=2, apple_gpu=16, cpu=2, nvidia_sm120=1, rocm=69, x86=65 | Add rows only when a launch path actually executes. |
