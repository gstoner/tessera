...
| Item | Status | Ready | Total | Open | Detail | Next |
|---|---|---:|---:|---:|---|---|
| `Verifier coverage` | mixed | 162 | 174 | 12 | no_verifier=12, real=162 | Add real verifier implementations for no_verifier ops, prioritizing native codegen lanes. |
...
| `ROCm / HIP` | closed | 96 | 96 | 0 | runtime: rocm=60; target_map: compiled=34, hardware_verified=2 | Close the artifact-only target-map tail and preserve CDNA as hardware-gated. |
...
| `Verifier coverage` | mixed | 12 | no_verifier=12, real=162 | Add real verifier implementations for no_verifier ops, prioritizing native codegen lanes. | `docs/audit/generated/verifier_coverage.csv` |
