...
| `ROCm / HIP` | closed | 104 | 104 | 0 | runtime: rocm=68; target_map: compiled=34, hardware_verified=2 | Close the artifact-only target-map tail and preserve CDNA as hardware-gated. |
