...
| `Runtime execution matrix` | closed | 133 | 133 | 0 | apple_cpu=2, apple_gpu=2, cpu=2, nvidia_sm120=1, rocm=65, x86=61 | Add rows only when a launch path actually executes. |
| `Runtime ABI symbols` | mixed | 396 | 649 | 253 | apple=557, nvidia=7, rocm=10, x86=75 | Reduce stub-only ABI rows where a backend claims native execution. |
