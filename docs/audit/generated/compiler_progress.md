...
| `Audited repo surfaces` | mixed | 31 | 63 | 32 | archived=4, compile_only=18, runnable=31, runnable_optional=1, scaffold=9 | Graduate compile_only/scaffold entries that exercise compiler pathways; archive dead surfaces. |
