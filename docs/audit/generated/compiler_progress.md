...
| `Runtime execution matrix` | closed | 153 | 153 | 0 | apple_cpu=2, apple_gpu=16, cpu=2, nvidia_sm120=1, rocm=69, x86=63 | Add rows only when a launch path actually executes. |
