...
|---|---|---|---|---|---|---|
| `apple_gpu` | `apple7` | `apple` | `matmul` | `release_ready` | `3fc5099dbdca` | `docs/audit/evidence/e2e_spine/apple_gpu/apple7` |
| `apple_gpu` | `apple7` | `apple` | `softmax` | `release_ready` | `3fc5099dbdca` | `docs/audit/evidence/e2e_spine/apple_gpu/apple7` |
