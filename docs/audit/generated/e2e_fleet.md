...
|---|---|---|---|---|---|---|
| `apple_gpu` | `apple7` | `apple` | `matmul` | `release_ready` | `a136395ec210` | `docs/audit/evidence/e2e_spine/apple_gpu/apple7` |
| `apple_gpu` | `apple7` | `apple` | `softmax` | `release_ready` | `a136395ec210` | `docs/audit/evidence/e2e_spine/apple_gpu/apple7` |
