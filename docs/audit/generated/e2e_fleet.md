...
|---|---|---|---|---|---|---|
| `apple_gpu` | `apple7` | `apple` | `matmul` | `release_ready` | `e7a284a5a73d` | `docs/audit/evidence/e2e_spine/apple_gpu/apple7` |
| `apple_gpu` | `apple7` | `apple` | `softmax` | `release_ready` | `e7a284a5a73d` | `docs/audit/evidence/e2e_spine/apple_gpu/apple7` |
