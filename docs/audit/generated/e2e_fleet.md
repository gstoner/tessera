...
| `x86` | `x86_64_base` | `x86` | `softmax` | `packet_pending` | - | - |
| `x86` | `x86_64_base` | `x86` | `reduction` | `packet_pending` | - | - |
...
| `nvidia_sm120` | `sm_120a` | `nvidia` | `softmax` | `packet_pending` | - | - |
| `nvidia_sm120` | `sm_120a` | `nvidia` | `reduction` | `packet_pending` | - | - |
