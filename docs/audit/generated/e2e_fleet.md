...
|---|---|---|---|---|---|---|
| `apple_gpu` | `apple7` | `apple` | `matmul` | `release_ready` | `41cac7d03874` | `docs/audit/evidence/e2e_spine/apple_gpu/apple7` |
| `apple_gpu` | `apple7` | `apple` | `softmax` | `release_ready` | `41cac7d03874` | `docs/audit/evidence/e2e_spine/apple_gpu/apple7` |
...
| `apple_cpu` | `apple_m1_max` | `apple` | `matmul` | `release_ready` | `41cac7d03874` | `docs/audit/evidence/e2e_spine/apple_cpu/apple_m1_max` |
