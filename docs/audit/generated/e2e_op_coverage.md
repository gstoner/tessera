...
| ``dropout`` | random_mask | public | public | registered | fused | device_verified_abi | ready | none |
| ``rng_normal`` | random_source | public | public | registered | fused | device_verified_abi | ready | none |
| ``rng_philox_normal`` | random_source | public | public | registered | fused | device_verified_abi | ready | none |
| ``rng_philox_uniform`` | random_source | public | public | registered | fused | device_verified_abi | ready | none |
| ``rng_uniform`` | random_source | public | public | registered | fused | device_verified_abi | ready | none |
...
| ``dct`` | spectral | public | public | registered | fused | device_verified_abi | ready | benchmarked |
| ``fft`` | spectral | public | public | registered | fused | device_verified_abi | ready | benchmarked |
...
| ``ifft`` | spectral | public | public | registered | fused | device_verified_abi | ready | benchmarked |
| ``irfft`` | spectral | public | public | registered | fused | device_verified_abi | ready | benchmarked |
| ``istft`` | spectral | public | public | registered | fused | device_verified_abi | ready | benchmarked |
| ``rfft`` | spectral | public | public | registered | fused | device_verified_abi | ready | benchmarked |
| ``spectral_conv`` | spectral | public | public | registered | fused | device_verified_abi | ready | benchmarked |
| ``spectral_filter`` | spectral | public | public | registered | fused | device_verified_abi | ready | benchmarked |
| ``stft`` | spectral | public | public | registered | fused | device_verified_abi | ready | benchmarked |
...
| ``stop_gradient`` | layout_transform | public | public | registered | not_applicable | not_applicable | ready | none |
