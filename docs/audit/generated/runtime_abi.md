...
- **511** unique `extern "C" tessera_*` C ABI symbols across all backends.
- **6 / 6** core runtime headers present.
- **150** Apple GPU kernel families with per-dtype variants.
...
| `dense_latent_attention_dev` | `f32` |
| `dequant_matmul` | `f32` |
...
| `metallib_elementwise` | `f32` |
| `metallib_pointwise` | `f16`, `f32` |
| `metallib_pointwise_reduce` | `f16`, `f32` |
...
| `optimizer` | `f32` |
| `paged_latent_attention_dev` | `f32` |
| `philox_dropout` | `f32` |
| `philox_normal` | `f32` |
| `philox_uniform` | `f32` |
| `popcount` | `i32` |
