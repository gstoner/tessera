...
| `apple_gpu` | `apple_value_target_ir` | `-` | `value_target_ir` | - | Apple GPU value-call execution is gated until a GPU value-call ABI adapter lands; the IR is classified + recorded, not dispatched. |
