...
- **4079** total Python-test references, **960** total lit-fixture references.
- **81** ops have **zero** references in either test surface.
- **117** ops have ≤1 reference ("thinly tested").
- **123** ops have ≥10 references ("well tested").
...
|----|--------:|---------:|------:|----:|--------|
| `matmul` |  402 |  225 |  627 |  17 | `bf16`, `f16`, `f32`, `f64` … |
...
| `mul` |   88 |    5 |   93 |   7 | `bf16`, `f16`, `f32`, `f64` … |
...
| `selective_ssm` |   67 |   10 |   77 |   2 | `bf16`, `f16`, `fp16`, `fp32` |
