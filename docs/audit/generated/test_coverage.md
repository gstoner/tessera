...
- **2955** total Python-test references, **825** total lit-fixture references.
...
- **97** ops have at least one associated `pytest.raises` negative test.
...
| `softmax` |  103 |   37 |  140 |  15 | `bf16`, `f16`, `f32`, `fp16` … |
