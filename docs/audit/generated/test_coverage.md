...
- **2973** total Python-test references, **825** total lit-fixture references.
...
- **99** ops have at least one associated `pytest.raises` negative test.
...
| `softmax` |  104 |   37 |  141 |  16 | `bf16`, `f16`, `f32`, `fp16` … |
