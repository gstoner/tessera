...
- **1784** total Python-test references, **485** total lit-fixture references.
...
| `silu` |   49 |    2 |   51 |   3 | `bf16`, `f16`, `f32`, `fp16` … |
