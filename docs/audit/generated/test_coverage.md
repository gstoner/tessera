...
- **1804** total Python-test references, **485** total lit-fixture references.
- **119** ops have **zero** references in either test surface.
- **226** ops have ≤1 reference ("thinly tested").
- **34** ops have ≥10 references ("well tested").
