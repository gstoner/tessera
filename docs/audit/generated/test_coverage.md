...
- **5683** total Python-test references, **1391** total lit-fixture references.
...
| `add` |  156 |   47 |  203 |  11 | `bf16`, `f16`, `f32`, `f64` … |
| `mul` |  146 |   41 |  187 |  12 | `bf16`, `f16`, `f32`, `f64` … |
...
| `gemm` |   86 |    2 |   88 |   8 | `bf16`, `f16`, `f32`, `fp16` … |
