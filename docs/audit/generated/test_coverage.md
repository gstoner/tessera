...
- **1761** total Python-test references, **485** total lit-fixture references.
...
|----|--------:|---------:|------:|----:|--------|
| `matmul` |  240 |  141 |  381 |  12 | `bf16`, `f16`, `f32`, `fp16` … |
...
| `silu` |   44 |    2 |   46 |   2 | `bf16`, `f16`, `f32`, `fp16` … |
| `cholesky` |   14 |   30 |   44 |   0 | `bf16`, `f16`, `f32`, `fp16` … |
| `rmsnorm` |   38 |    4 |   42 |   1 | `bf16`, `fp32` |
