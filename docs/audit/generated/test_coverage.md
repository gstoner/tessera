...
- **2857** total Python-test references, **825** total lit-fixture references.
...
- **81** ops have at least one associated `pytest.raises` negative test.
...
| `softmax` |   96 |   37 |  133 |   8 | `bf16`, `f16`, `f32`, `fp16` … |
