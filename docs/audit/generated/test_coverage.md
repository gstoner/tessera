...
- **1678** total Python-test references, **485** total lit-fixture references.
...
| `silu` |   22 |    2 |   24 |   0 | `bf16`, `f16`, `f32`, `fp16` … |
