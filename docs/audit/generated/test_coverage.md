...
- **2602** total Python-test references, **731** total lit-fixture references.
...
|----|--------:|---------:|------:|----:|--------|
| `matmul` |  365 |  164 |  529 |  15 | `bf16`, `f16`, `f32`, `f64` … |
...
| `mul` |   81 |    4 |   85 |   7 | `bf16`, `f16`, `f32`, `f64` … |
| `reduce` |   83 |    0 |   83 |   7 | `f32`, `fp16`, `fp32`, `fp4_e2m1` … |
| `silu` |   80 |    2 |   82 |   5 | `bf16`, `f16`, `f32`, `f64` … |
