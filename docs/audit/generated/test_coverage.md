...
- **6027** total Python-test references, **1470** total lit-fixture references.
...
|----|--------:|---------:|------:|----:|--------|
| `matmul` |  500 |  312 |  812 |  25 | `bf16`, `f16`, `f32`, `f64` … |
| `add` |  165 |   68 |  233 |  12 | `bf16`, `f16`, `f32`, `f64` … |
| `mul` |  189 |   41 |  230 |  15 | `bf16`, `f16`, `f32`, `f64` … |
...
| `sum` |   69 |    0 |   69 |   6 | `bf16`, `f16`, `f32`, `fp16` … |
