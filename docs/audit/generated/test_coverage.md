...
- **2998** total Python-test references, **825** total lit-fixture references.
...
- **102** ops have at least one associated `pytest.raises` negative test.
...
| `softmax` |  108 |   37 |  145 |  20 | `bf16`, `f16`, `f32`, `fp16` … |
