...
- **2990** total Python-test references, **825** total lit-fixture references.
...
- **101** ops have at least one associated `pytest.raises` negative test.
...
| `softmax` |  107 |   37 |  144 |  19 | `bf16`, `f16`, `f32`, `fp16` … |
