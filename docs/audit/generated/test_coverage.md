...
- **3605** total Python-test references, **881** total lit-fixture references.
...
- **113** ops have at least one associated `pytest.raises` negative test.

## Top 20 most-tested ops

| Op | py refs | lit refs | total | neg | dtypes |
|----|--------:|---------:|------:|----:|--------|
| `matmul` |  394 |  207 |  601 |  18 | `bf16`, `f16`, `f32`, `f64` … |
| `flash_attn` |  105 |   57 |  162 |   8 | `bf16`, `f32`, `fp16`, `fp32` … |
| `softmax` |  120 |   37 |  157 |  30 | `bf16`, `f16`, `f32`, `fp16` … |
| `relu` |  106 |   22 |  128 |   9 | `bf16`, `f16`, `f32`, `f64` … |
| `add` |  106 |   17 |  123 |  10 | `bf16`, `f16`, `f32`, `f64` … |
| `mul` |   87 |    5 |   92 |   7 | `bf16`, `f16`, `f32`, `f64` … |
| `silu` |   85 |    5 |   90 |   5 | `bf16`, `f16`, `f32`, `f64` … |
