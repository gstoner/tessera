...
- **2980** total Python-test references, **825** total lit-fixture references.
...
- **100** ops have at least one associated `pytest.raises` negative test.
...
| `softmax` |  105 |   37 |  142 |  17 | `bf16`, `f16`, `f32`, `fp16` … |
