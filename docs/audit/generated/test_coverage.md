...
- **4581** total Python-test references, **1140** total lit-fixture references.
...
|----|--------:|---------:|------:|----:|--------|
| `matmul` |  451 |  246 |  697 |  20 | `bf16`, `f16`, `f32`, `f64` … |
| `flash_attn` |  125 |   72 |  197 |   9 | `bf16`, `f16`, `f32`, `f64` … |
...
| `reduce` |   97 |   15 |  112 |   7 | `bf16`, `f16`, `f32`, `f64` … |
