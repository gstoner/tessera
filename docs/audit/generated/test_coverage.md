...
- **2071** total Python-test references, **498** total lit-fixture references.
...
- **53** ops have at least one associated `pytest.raises` negative test.

## Top 20 most-tested ops

| Op | py refs | lit refs | total | neg | dtypes |
|----|--------:|---------:|------:|----:|--------|
| `matmul` |  268 |  133 |  401 |  14 | `bf16`, `f16`, `f32`, `fp16` … |
...
| `cast` |    4 |   23 |   27 |   0 | `fp32` |
| `rope` |   16 |   10 |   26 |   0 |  |
| `grouped_gemm` |   25 |    0 |   25 |   2 | `fp32`, `fp4_e2m1`, `fp8_e4m3`, `fp8_e5m2` … |
