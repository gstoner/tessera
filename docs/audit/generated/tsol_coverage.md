...
Counts below are restricted to the 51 TSOL canonical names.  The full 505-primitive registry is summarised in `docs/audit/standalone_primitive_coverage.md`.
