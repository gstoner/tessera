...
| `permute` | tensor_algebra | partial | yes | registered | partial | jvp, batching_rule, transpose_rule, sharding_rule, backend_kernel, tests | - |
| `collective_permute` | collective | partial | yes | stub_required | reference_only | batching_rule, lowering_rule, backend_kernel | all |
...
| `selective_ssm` | state_space | partial | yes | missing | reference_only | math_semantics, shape_rule, dtype_layout_rule, jvp, batching_rule, sharding_rule, masking_effect_rule, backend_kernel, tests | Mamba/SSM |
