...
> RDNA3 ISA — pages 10–10

Preface

About This Document
This document describes the current environment, organization and program state of AMD "RDNA3"
...
Organization
This document begins with an overview of the AMD RDNA3 processors' hardware and programming
