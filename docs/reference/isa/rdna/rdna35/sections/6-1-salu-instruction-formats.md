...
Valid operands of SALU instructions are:
  ...
  • If the destination is NULL, the instruction does not execute: nothing is written to SGPRs, but SCC is written
    if the instruction normally updates SCC.
