...
Select the IEEE minimumNumber() of three single-precision float inputs and store the result into a vector
register.
...
Select the IEEE maximumNumber() of three single-precision float inputs and store the result into a vector
register.
...
Select the IEEE minimumNumber() of three half-precision float inputs and store the result into a vector
register.
...
Select the IEEE maximumNumber() of three half-precision float inputs and store the result into a vector
register.
...
Select the IEEE minimumNumber() of the first two single-precision float inputs and then select the IEEE
maximumNumber() of that result and third single-precision float input. Store the final result into a vector
register.
...
Supports input denorm control and allows output denorm value. Exceptions are supported. Note: +0.0 > -0.0 is
true.

This is suitable for emulating an API-level "clamp"; unlike MED3 this correctly handles the case where the
clamp's minBound > maxBound.

V_MAXMIN_NUM_F32                                                                                              617

Select the IEEE maximumNumber() of the first two single-precision float inputs and then select the IEEE
minimumNumber() of that result and third single-precision float input. Store the final result into a vector
register.
...
Select the IEEE minimumNumber() of the first two half-precision float inputs and then select the IEEE
maximumNumber() of that result and third half-precision float input. Store the final result into a vector
register.
...
Select the IEEE maximumNumber() of the first two half-precision float inputs and then select the IEEE
minimumNumber() of that result and third half-precision float input. Store the final result into a vector
register.
...
Select the IEEE minimum() of the first two single-precision float inputs and then select the IEEE maximum() of
that result and third single-precision float input. Store the final result into a vector register.
...
Select the IEEE maximum() of the first two single-precision float inputs and then select the IEEE minimum() of
that result and third single-precision float input. Store the final result into a vector register.
...
Select the IEEE minimum() of the first two half-precision float inputs and then select the IEEE maximum() of
that result and third half-precision float input. Store the final result into a vector register.
...
Select the IEEE maximum() of the first two half-precision float inputs and then select the IEEE minimum() of
that result and third half-precision float input. Store the final result into a vector register.
...
Calculate the reciprocal of the single-precision float input using IEEE rules and store the result into a scalar
register.
...
Calculate the reciprocal of the half-precision float input using IEEE rules and store the result into a scalar
register.
...
Calculate the square root of the single-precision float input using IEEE rules and store the result into a scalar
register.
...
Calculate the square root of the half-precision float input using IEEE rules and store the result into a scalar
register.
...
Compare with V_PERMLANE16_B32; this opcode allows each lane to specify its own gather lane in a VGPR
whereas V_PERMLANE16_B32 has a fixed (scalar) gather lane pattern for each group of 16 lanes.

Compare with V_PERMLANEX16_VAR_B32.
...
Compare with V_PERMLANEX16_B32; this opcode allows each lane to specify its own gather lane in a VGPR
whereas V_PERMLANEX16_B32 has a fixed (scalar) gather lane pattern for each group of 16 lanes.

Compare with V_PERMLANE16_VAR_B32.
...
Convert from two single-precision float inputs to a packed FP8 float value using round to nearest even
...
Convert from two single-precision float inputs to a packed BF8 float value using round to nearest even
semantics and store the result into 16 bits of a vector register using OPSEL.
...
Convert from a single-precision float input to an FP8 float value with stochastic rounding using seed data from
the second input. Store the result into 8 bits of a vector register using OPSEL to determine which byte of the
...
Convert from a single-precision float input to a BF8 float value with stochastic rounding using seed data from
the second input. Store the result into 8 bits of a vector register using OPSEL to determine which byte of the
destination to overwrite.
