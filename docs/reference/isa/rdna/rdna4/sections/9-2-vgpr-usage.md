...
BUFFER_LOAD_FORMAT_XYZ                 FORMAT field          float, uint or sint                    write only 16 bits)
                                                             Load X,Y,Z into V0[31:0], V1[31:0],
                                                             V2[31:0]
...
BUFFER_LOAD_D16_HI_FORMAT_X            FORMAT field          float, uint16 or int16
                                                             Load X into in V0[31:16]
BUFFER_LOAD_D16_FORMAT_XY              FORMAT field          float, uint16 or int16
                                                             Load X,Y into in V0[15:0], V0[31:16]
BUFFER_LOAD_D16_FORMAT_XYZ             FORMAT field          float, uint16 or int16
                                                             Load X,Y,Z into in V0[15:0],
                                                             V0[31:16], V1[15:0]
BUFFER_LOAD_D16_FORMAT_XYZW            FORMAT field          float, uint16 or int16
...
BUFFER_STORE_D16_FORMAT_X              float, uint16 or int16                                       field.
                                       data in V0[15:0]
BUFFER_STORE_D16_FORMAT_XY             float, uint16 or int16
                                       data in V0[15:0], V0[31:16]
BUFFER_STORE_D16_FORMAT_XYZ            float, uint16 or int16
                                       data in V0[15:0], V0[31:16],
                                       V1[15:0]
BUFFER_STORE_D16_FORMAT_XYZW           float, uint16 or int16
                                       data in V0[15:0], V0[31:16],
                                       V1[15:0], V1[31:16]
BUFFER_STORE_D16_HI_FORMAT_X           float, uint16 or int16
                                       data in V0[31:16]
