// RUN: tessera-ebt-opt %s -tessera-ebt-canonicalize -tessera-ebt-lower --backend=cpu --ebt-K=2 --ebt-T=3 | FileCheck %s
...
// CHECK: // tessera-ebt-opt options: K=2 T=3 useJVP=false backend=cpu
