...
What is wanted for hardware - seperate coversation 
...
Short version: give the compiler tiles, DMA, and collectives as hard guarantees; expose clean tile-level ISA with counters for autotuning; wire it to a fat interconnect. That’s the silicon that lets the language hit “write it once, auto-tune to peak” across training and serving.
