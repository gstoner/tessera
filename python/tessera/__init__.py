...
from . import linalg_ops  # noqa: E402,F401  registers the MC1 matrix-function family
from . import metric  # noqa: E402,F401  MC3 metric/tangent protocol for grad(metric=)
