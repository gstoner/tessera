...
def _verify_attention_schedule_ancestry(artifact) -> None:
    from .native_attention_contract import project_attention_descriptor
    project_attention_descriptor(artifact, _verify_schedule_ancestry(artifact))
...
def _verify_kernel_schedule_ancestry(artifact: ScheduledKernelArtifact) -> None:
    from .native_unary_contract import verify_unary_projection
    verify_unary_projection(artifact, _verify_schedule_ancestry(artifact))
