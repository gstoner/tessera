...
KNOWN_EXECUTORS: dict[EXECUTOR_ID, str] = {
    ...
    "x86_linalg_compiled": "x86 CPU dense linear algebra (cholesky / tri_solve / "
                            "cholesky_solve) — AVX-512 Cholesky–Banachiewicz "
                            "factorization + forward/back triangular substitution "
                            "(RHS columns vectorized); cholesky_solve = two "
                            "triangular solves. Batched. f32",
    ...
    "rocm_linalg_compiled": "AMD GPU RDNA dense linear algebra (cholesky / "
                            "tri_solve / cholesky_solve) — COMPILER-GENERATED "
                            "gfx1151 kernels (generate-rocm-cholesky-kernel one "
                            "thread per matrix, generate-rocm-tri-solve-kernel "
                            "one thread per matrix/RHS-column) HIP-launched; "
...
_MATRIX: dict[tuple[str, str], ExecutionRow] = {
    ...
    ("x86", "x86_linalg_compiled"): ExecutionRow(
        ...
        reason="x86 linalg lane (cholesky / tri_solve / cholesky_solve) runs the "
               "AVX-512 kernels — Cholesky–Banachiewicz factorization + forward/"
               "back triangular substitution (RHS columns vectorized); "
               "cholesky_solve composes two triangular solves. Batched. f32, "
               "matches numpy.",
        execution_mode="cpu_avx512"),
    ...
    ("rocm", "rocm_linalg_compiled"): ExecutionRow(
        ...
        reason="ROCm linalg lane (cholesky / tri_solve / cholesky_solve) runs the "
               "COMPILER-GENERATED gfx1151 kernels (generate-rocm-cholesky-kernel "
               "one thread per matrix, generate-rocm-tri-solve-kernel one thread "
               "per matrix/RHS-column) HIP-launched; cholesky_solve composes two "
