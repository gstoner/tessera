...
REGISTERED_PASSES: tuple[PassMetadata, ...] = (
    ...
    PassMetadata(
        ...
        preserved_attrs=("tessera.source_state", "tessera.autodiff.product_abi", "tessera.autodiff.product_pair", "tessera.ann.source", "tessera.autodiff.temporary_bytes", "tessera.autodiff.gpu_status", "tessera.autodiff.input_status", "tessera.autodiff.input_status_count", "tessera.native_result_program", "tessera.native_result_abi", "tessera.native_result_status"),
