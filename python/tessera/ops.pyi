...
# Linear algebra
def gemm(A: Tensor, B: Tensor, *, epilogue: Optional[Epilogue] = ..., bias: Optional[Tensor] = ..., residual: Optional[Tensor] = ..., activation: Activation = ...) -> Tensor: ...
def matmul(A: Tensor, B: Tensor, *, epilogue: Optional[Epilogue] = ..., bias: Optional[Tensor] = ..., residual: Optional[Tensor] = ..., activation: Activation = ...) -> Tensor: ...
...
def es_low_rank_correction(
    ...
    *,
    ...
    sigma: float,
    epoch: int = ...,
    score: Literal["gaussian"] = ...,
    antithetic: bool = ...,
    numeric_policy: Optional[NumericPolicy] = ...,
) -> Tensor: ...
...
def attn_with_stats(
    query: Tensor, sources: Tensor, *, eps: float = ...
) -> Tuple[Tensor, Tensor, Tensor]: ...
def depth_attn(query: Tensor, sources: Tensor, *, eps: float = ...) -> Tensor: ...
def softmax_merge(
    output_a: Tensor,
    maximum_a: Tensor,
    normalizer_a: Tensor,
...
def softmax_finalize(output: Tensor, normalizer: Tensor) -> Tensor: ...
...
def nesterov(params: Any, grads: Any, state: Optional[dict[str, Any]] = ..., **kwargs: Any) -> Tuple[Any, dict[str, Any]]: ...
...
def stft(x: Tensor, win: Tensor, *, hop: int, axis: int = ..., n_fft: int | None = ..., center: bool = ..., pad_mode: str = ..., onesided: bool = ...) -> Tensor: ...
def istft(xf: Tensor, win: Tensor, *, hop: int, axis: int = ..., n_fft: int | None = ..., center: bool = ..., length: int | None = ..., onesided: bool = ...) -> Tensor: ...
...
def rearrange(
    x: Tensor,
    layout: Union[Layout, str, Sequence[int]],
    axes_lengths: Optional[Mapping[str, int]] = ...,
) -> Tensor: ...
