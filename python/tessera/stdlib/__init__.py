...
The standard library the large-MoE-model frontends (DeepSeek-V3.2 / GLM-5 /
Kimi-K2) compose against.  Distinct from ``tessera.ops`` (the op catalog) and
...
from . import attention, moe, quant

__all__ = ["quant", "moe", "attention"]
