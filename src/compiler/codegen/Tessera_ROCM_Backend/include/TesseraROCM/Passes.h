...
std::unique_ptr<mlir::Pass> createROCMDynamicLDSPass();
...
std::unique_ptr<mlir::Pass> createGenerateROCMInt4PackKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMDequantGemmKernelPass();
...
std::unique_ptr<mlir::Pass> createGenerateROCMSelectiveSsmBwdKernelPass();
...
std::unique_ptr<mlir::Pass> createGenerateROCMTridiagonalKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMCoalitionButterflyKernelPass();
...
std::unique_ptr<mlir::Pass> createGenerateROCMRecurrentCellKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMBatchedGemmF32KernelPass();
...
std::unique_ptr<mlir::Pass> createGenerateROCMDSparkDraftBlockKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMMLAAbsorbDecodeKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMBlockSparseAttnKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMBlockSparseTopKKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMSoftmaxKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMDepthAttentionKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMNormKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMReduceKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMPagedKVReadKernelPass();
...
std::unique_ptr<mlir::Pass> createGenerateROCMSolverIFTKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMSpectralBackwardKernelPass();
...
std::unique_ptr<mlir::Pass> createGenerateROCMEbmAffineLangevinKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMEbmPartitionKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMEbmDecodeInitKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMEbmEnergyQuadraticKernelPass();
std::unique_ptr<mlir::Pass> createGenerateROCMEbmEbtTinyKernelPass();
