...
//
// This file is the gfx11 acceptance; `canonical_lds_arch_refused.mlir` is the
// gfx12 refusal. Found 2026-09-19 by a structural search for accumulator index
// math carrying no arch branch, on a file a substring audit had cleared.

// RUN: %trop --allow-unregistered-dialect --generate-wmma-gemm-kernel='canonical-staging=lds' %s | FileCheck %s
...
module attributes {tessera.arch = "gfx1151"} {
  func.func @canonical_gemm(%a: memref<?xf16>, %b: memref<?xf16>, %d: memref<?xf32>,
    ...
    "tessera_rocm.wmma_gemm"() {
      ...
      mt = 1 : i64, nt = 1 : i64, arch = "gfx1151",
