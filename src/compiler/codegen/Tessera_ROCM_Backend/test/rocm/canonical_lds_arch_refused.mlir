...
// RUN: not %trop --tessera-tiling --tessera-tile-ir-lowering --rocm-wave-lds-pipeline --rocm-wave-lds-legality --generate-wmma-gemm-kernel='canonical-staging=lds' %s 2>&1 | FileCheck %s
