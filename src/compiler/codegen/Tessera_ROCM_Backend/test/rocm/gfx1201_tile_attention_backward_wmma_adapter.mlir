...
// RUN: %trop --allow-unregistered-dialect --pass-pipeline='builtin.module(lower-tile-to-rocm{arch=gfx1201},generate-wmma-flash-attn-bwd-kernel)' %s | FileCheck %s --check-prefix=KERNEL
...
// TARGET-SAME: schedule = "gfx1201_wmma_backward_split_reduced"
