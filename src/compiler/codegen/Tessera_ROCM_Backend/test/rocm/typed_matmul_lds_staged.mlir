...
// on every fragment read. One dword makes the stride 9 dwords, and
// `gcd(9, 32) = 1` is conflict-free.
//
// The default moved 4 -> 1 on 2026-09-20 (wmma-fragment-layout.md 10u/10v):
// paired and interleaved on BOTH ROCm parts, 1 beats 4 by 1.10-1.19x on
// gfx1201 and 1.21-1.29x on gfx1151, 6/6 at 2048 and 4096 cubed with
// double-buffering on and off. The earlier 4 (10k) came from one shape in a
// configuration predating issue depth.
//
// So 64*18 + 128*18 halves = 6912 bytes, not 64*16 + 128*16 = 6144. If these
