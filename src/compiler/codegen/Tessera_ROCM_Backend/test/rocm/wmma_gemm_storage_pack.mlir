...
// `tessera.storage_pack = {logical, container, factor}` (emitted by the
...
"tessera_rocm.wmma_gemm"() {name = "g", m = 16 : i64, n = 16 : i64, k = 16 : i64,
  mt = 16 : i64, nt = 16 : i64,
  tessera.storage_pack = {logical = "int4", container = "int8", factor = 2 : i64}} : () -> ()
...
"tessera_rocm.wmma_gemm"() {name = "g", m = 16 : i64, n = 16 : i64, k = 16 : i64,
  mt = 16 : i64, nt = 16 : i64,
  tessera.storage_pack = {logical = "int4", container = "int8", factor = 1 : i64}} : () -> ()
