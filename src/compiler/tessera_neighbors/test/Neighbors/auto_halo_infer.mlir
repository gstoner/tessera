...
%st   = "tessera.neighbors.stencil.define"() {taps = [#tessera.neighbors.delta_array<[0,0]>, #tessera.neighbors.delta_array<[+1,0]>, #tessera.neighbors.delta_array<[-1,0]>, #tessera.neighbors.delta_array<[0,+1]>, #tessera.neighbors.delta_array<[0,-1]>], coeffs = [1.0 : f64, 1.0 : f64, 1.0 : f64, 1.0 : f64, 1.0 : f64]\n} : () -> !tessera.stencil
