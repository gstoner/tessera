...
func.func @spd_solve(%A: tensor<128x128xf32>, %b: tensor<128xf32>) -> tensor<128xf32> {
  ...
  %L   = "tessera_solver.potrf"(%Af8) { policy = #tessera_solver.precision<"fp8:e4m3","f32","f32","per_tile"> } : (tensor<128x128x!tessera.fp8.e4m3>) -> tensor<128x128x!tessera.fp8.e4m3>
  %x0  = "tessera_solver.potrs"(%L, %b) : (tensor<128x128x!tessera.fp8.e4m3>, tensor<128xf32>) -> tensor<128xf32>
  // CHECK: tessera_solver.potrf
  // CHECK-SAME: policy
