...
func.func @shallow_water(%u: tensor<64x64xf32>, %v: tensor<64x64xf32>, %h: tensor<64x64xf32>) -> tensor<64x64xf32> {
  %gu = "tpp.grad"(%h) {scheme = "central", order = 2 : i64, spacing = [1.0 : f64, 1.0 : f64]} : (tensor<64x64xf32>) -> tensor<64x64xf32>
  %u1 = "tpp.bc.enforce"(%gu) { bc = #tpp.bc<"periodic"> } : (tensor<64x64xf32>) -> tensor<64x64xf32>
