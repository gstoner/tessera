...
// concrete structured #tile.packed_format descriptor for a
...
// (TILE_BARRIER_ORIGIN_UNRESOLVED), pipeline-ring advancement
// (TILE_PIPELINE_RING_STALE / _UNDERIVED), and SSA-keyed TMA expect
