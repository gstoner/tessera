...
| Goal | Command |
|---|---|
| Daily edit-loop sanity check (~8,150 fast tests, ~4 min, < 512 MB RAM) | `pytest tests/unit/ -m "not slow" -q` |
| Full Python suite including heavy benchmarks (~8,920 collected total; ~30 min full sweep, ~2 GB RAM) | `pytest tests/unit/ -q` |
