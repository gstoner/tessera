...
from tests._support.nvidia import (
    nvidia_mma_ptx_launch_available,
    nvidia_mma_runtime_available,
)


def _nvidia_cuda_live() -> bool:
    """Compatibility name for the ordinary shared MMA-runtime capability."""
    return nvidia_mma_runtime_available()
...
def _nvidia_matmul_live() -> bool:
    """Compatibility name for the stronger shared MMA/PTX capability."""
    return nvidia_mma_ptx_launch_available()
