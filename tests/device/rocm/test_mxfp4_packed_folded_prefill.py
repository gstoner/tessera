...
@pytest.mark.parametrize(
    "integer_decode,batched_loads,batched_a_loads,reuse_pair_scales,permute_decode,vector_pair_loads,a_base_hoist",
    [(False, False, False, False, False, False, False),
     ...
     pytest.param(False, False, False, False, True, True, False, id="vector_pair"),
     pytest.param(False, True, False, False, True, False, True, id="a_base_hoist")],
)
def test_packed_folded_prefill_matches_declared_oracle(
    ...
    vector_pair_loads: bool, a_base_hoist: bool,
) -> None:
