...
@pytest.mark.parametrize(
    "integer_decode,batched_loads,batched_a_loads,reuse_pair_scales,permute_decode,vector_pair_loads,a_base_hoist,a_offset32",
    [(False, False, False, False, False, False, False, False),
     ...
     pytest.param(False, False, False, False, True, True, False, False, id="vector_pair"),
     pytest.param(False, True, False, False, True, False, True, False, id="a_base_hoist"),
     pytest.param(False, True, False, False, True, False, False, True, id="a_offset32")],
)
def test_packed_folded_prefill_matches_declared_oracle(
    ...
    vector_pair_loads: bool, a_base_hoist: bool, a_offset32: bool,
) -> None:
