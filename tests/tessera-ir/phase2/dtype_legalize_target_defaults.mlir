...
// RUN: tessera-opt --allow-unregistered-dialect --pass-pipeline='builtin.module(tessera-lower-to-gpu{legalize-dtypes=true})' %s | FileCheck %s --check-prefix=NVIDIA-PACK
//
...
// NVIDIA-PACK: "test.dtype_request"
// NVIDIA-PACK-SAME: numeric_policy = {accum = "int32", storage = "int4"}
// NVIDIA-PACK-SAME: tessera.storage_pack = {container = "int8", factor = 2 : i64, logical = "int4", signedness = "signed_twos_complement"}
