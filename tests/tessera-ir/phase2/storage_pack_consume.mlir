...
// factor, signedness} descriptor a backend's packed load/store reads. factor =
...
// CHECK: tessera.storage_pack = {container = "int8", factor = 2 : i64, logical = "fp4_e2m1", signedness = "format_defined"}
...
// CHECK: tessera.storage_pack = {container = "int8", factor = 1 : i64, logical = "fp6_e3m2", signedness = "format_defined"}
...
// CHECK: factor = 2 : i64, logical = "int4", signedness = "signed_twos_complement"
