...
// k_blocks = 8, while the MXFP4-format scale group remains independently K=32.
// `k_blocks > 1` used to be refused by every consumer
// (ROCM-MACRO-K-TILE-1).
// CHECK: k_blocks = 8
...
#scaled = #tile.mma_desc<family = "wmma", m = 16, n = 16, k = 16,
                         ...
                         k_blocks = 8, scale_k = 32, scale_fmt = "fp32">
