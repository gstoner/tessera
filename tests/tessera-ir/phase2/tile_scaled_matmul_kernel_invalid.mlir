...
// CHECK: 'tile.scaled_matmul_kernel' op partial_accumulator must state zero-init, scale-group scope, scale_outer_product_then_add, and scale_k/instruction_k steps
