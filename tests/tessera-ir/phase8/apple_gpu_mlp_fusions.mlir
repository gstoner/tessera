...
// Runtime declarations (CHECK-DAG since order is implementation-defined).
// CHECK-DAG: func.func private @tessera_apple_gpu_matmul_gelu_f32(i64, i64, i64, i32, i32, i32)
// CHECK-DAG: func.func private @tessera_apple_gpu_matmul_rmsnorm_f32(i64, i64, i64, i32, i32, i32, f32)
