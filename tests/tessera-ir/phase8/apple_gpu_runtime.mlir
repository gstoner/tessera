...
// Phase 8.3 — Apple GPU native execution path. Verifies that the runtime
// pipeline lowers a static-shape f32 matmul to a func.call into the MPS
// runtime shim. Mirrors the Phase 8.2 apple_cpu_runtime.mlir fixture; the
// only difference is the call target.

// CHECK-LABEL: func.func private @tessera_apple_gpu_mps_matmul_f32
...
// Negative case: dynamic shapes are rejected by the Phase 8.3 path; the op
