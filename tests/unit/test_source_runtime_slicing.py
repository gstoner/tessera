...
def test_dynamic_gather_reverse_refuses_without_an_adjoint():
    ...
    with pytest.raises(subprocess.CalledProcessError) as caught:
        _run(compiler,'--tessera-autodiff-paired',source=ir)
    assert 'tensor.generate' in caught.value.stderr
