"""Compiler-generated spectral composites on x86 AVX-512 (Spectral PR5) — dct /
stft / istft / spectral_conv / spectral_filter, each composing the
x86_fft_compiled FFT lane (framing / windowing / overlap-add / pointwise complex
mul on host). Reachable via `compiler_path="x86_spectral_compiled"`. Validated vs
np.fft. Skip-clean: x86 FFT shared lib not built.
"""
